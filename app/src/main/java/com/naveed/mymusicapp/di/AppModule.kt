...
import com.naveed.mymusicapp.server.domain.usecases.GetRecentMediaItem
...
object AppModule {
    ...
    fun provideSongListUseCases(
        ...
        musicServiceClientUseCases: MusicServiceClientUseCases
    ): SongListUseCases {
    ...
    fun provideMusicServiceUseCases(
        ...
        return MusicServiceUseCases(
            ...
            getRecentMediaItem = GetRecentMediaItem(musicRepository = musicRepository)
        )
    }
}